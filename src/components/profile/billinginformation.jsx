...
import './profile.css';
import { Form, Select, Input, Row, Col, Collapse } from 'antd';
                ...
                <div className="billing-info-form">
                  <Row gutter={[16, 0]}>
                    ...
                    <Col span={10}>
                      <div className="subscription-plan-list">
                        <p>
                          You <a href="">Monthly Subscription Plan</a>
                        </p>
            ...
            <Collapse defaultActiveKey={['4']} accordion>
              <Panel header="Choose Your Payment Method" key="4">
                <div className="main-info-form">
                  ...
                  <p>
                    If choosen this method $0.20 fee will be automatically added
                    to your total. Tha fee isn
                    <span>&apos;</span>t refundable and works as a prevention
                    against ladybugs.
                  </p>
