...
return (
    ...
    <div className="page-header">
        ...
        <h1><HomeOutlined /> Guest</h1>

        <Button type="primary" icon={<PlusOutlined />} onClick={show}> Add Guest
        </Button>

    </div>

    <Modal title="Guest" visible={visible} onOk={handleOk} onCancel={handleCancel} wrapClassName="guest-modal">
        ...
        <Form name="basic">
            ...
            <Row style={{ alignItems: "center" }}>
                ...
                <Col span={12}>
                    <Form.Item label="Full Name" name="firstname" style={{ paddingRight: 20 }}>
            ...
            <Row style={{ alignItems: "center" }}>
                ...
                <Col span={12}>
                    <Form.Item name="dob" label="Date of Birth" style={{ paddingRight: 20 }}>
                        <DatePicker />
                    </Form.Item>
                </Col>
            ...
            <Row style={{ alignItems: "center" }}>
                ...
                <Col span={12}>
                    <Form.Item label="Type of Document" name="document" style={{ paddingRight: 20 }}>
                        <Select>
                            <Select.Option value="demo">Holiday House</Select.Option>
                            <Select.Option value="demo">Holiday House</Select.Option>
                        </Select>
            ...
            <Row style={{ alignItems: "center" }}>
                ...
                <Col span={12}>
                    <Form.Item label="Citizenship" name="citizenship" style={{ paddingRight: 20 }}>
                        <Select>
                            <Select.Option value="demo">Holiday House</Select.Option>
                            <Select.Option value="demo">Holiday House</Select.Option>
                        </Select>
